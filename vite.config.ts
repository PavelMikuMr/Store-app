  ...
  return defineConfig({
    ...
    resolve: {
      alias: {
        ...
        '@components_i': path.resolve(__dirname, './src/components/index'),
        '@type': path.resolve(__dirname, './types'),
        '@type_i': path.resolve(__dirname, './types/index'),
        '@fields_i': path.resolve(__dirname, './src/components/fields/index'),
